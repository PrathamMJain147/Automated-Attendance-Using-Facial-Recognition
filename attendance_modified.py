...
def login():
    ...
    ######################################### Function to recognize the face
                ...
                def class_register():
                    ...
                    classRegister_frame.pack()
                
                    title = Label(classRegister_frame, text = "Class Register", font = ('times new roman', 20, 'bold') , fg = 'green', bd = 3, relief = SUNKEN)    
                    title.place(x = 3, y = 3, relwidth = 1)     
                    def back():
                ...
                def report():
                    ...
                    report_table = Treeview(table_frame, columns = ("ID","USN", "Name", "Class Name", "Date","Time","Status"), xscrollcommand = scroll_x.set, yscrollcommand = scroll_y.set)
                    scroll_x.pack(side = BOTTOM, fill = X )
                    scroll_y.pack(side = RIGHT, fill = Y)
                    ...
                    report_table.heading("Class Name", text= "Classs Name")
                ...
                B7 = Button(attendance, text="Class Register" ,fg = "green",font =("Times new roman",15), image = photo7, height = 300, width = 265, command = class_register, compound = BOTTOM )
